...
export default function SellingPage() {
  ...
  return (
    <section className={styles.container}>
      ...
      {/* Featured Properties Section - Using RealEstateSlider */}
      <div className={styles.propertiesSection}>
        ...
        {realEstates.length > 0 ? (
          ...
          <div className={styles.emptyState}>
            ...
            <p className={styles.emptyText}>No properties available at the moment.</p>
            <p className={styles.emptySubtext}>Check back later for new listings.</p>
          </div>
        )}
      </div>
